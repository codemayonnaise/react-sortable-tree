  ...
  render() {
    ...
    if (canDrag) {
      if (typeof node.children === 'function' && node.expanded) {
        ...
        }, [...new Array(12)].map((_, index) => /*#__PURE__*/React.createElement("div", {
    ...
    }, buttons.map((btn, index) => /*#__PURE__*/React.createElement("div", {
...
class TreePlaceholder extends Component {
  render() {
    ...
    return connectDropTarget( /*#__PURE__*/React.createElement("div", null, Children.map(children, child => /*#__PURE__*/cloneElement(child, { ...otherProps
    }))));
  }
