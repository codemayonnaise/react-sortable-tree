  ...
  render() {
    ...
    if (canDrag) {
      if (typeof node.children === 'function' && node.expanded) {
        ...
        }, [...new Array(12)].map((_, index) => /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    }, buttons.map((btn, index) => /*#__PURE__*/React__default['default'].createElement("div", {
...
class TreePlaceholder extends React.Component {
  render() {
    ...
    return connectDropTarget( /*#__PURE__*/React__default['default'].createElement("div", null, React.Children.map(children, child => /*#__PURE__*/React.cloneElement(child, { ...otherProps
    }))));
  }
...
const memoize = f => {
  ...
  return args => {
    ...
    const argsArray = keysArray.map(key => args[key]); // If the arguments for the last insert operation are different than this time,
...
class DndManager {
  ...
  getTargetDepth(dropTargetProps, monitor, component) {
    ...
    if (monitor.getItem().treeId !== this.treeId) {
      ...
      if (component) {
        const relativePosition = reactDom.findDOMNode(component).getBoundingClientRect(); // eslint-disable-line react/no-find-dom-node
    ...
    const nodeDropTarget = {
      ...
      hover: (dropTargetProps, monitor, component) => {
        ...
        this.rafId = requestAnimationFrame(() => {
          const item = monitor.getItem(); // skip if drag already ended before the animation frame
...
function slideRows(rows, fromIndex, toIndex, count = 1) {
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function render() {
      ...
      if (rows.length < 1) {
        ...
        list = /*#__PURE__*/React__default['default'].createElement(reactVirtualized.AutoSizer, {
          nonce: cssNonce
        }, function (_ref11) {
...
ReactSortableTree.propTypes = {
  ...
  cssNonce: PropTypes__default['default'].string,
